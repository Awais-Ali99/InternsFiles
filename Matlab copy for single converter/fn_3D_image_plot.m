...
for el = 1:64
    ...
    p1 = [x-PROBE.ELEMENT_MINOR(1)/2 y-PROBE.ELEMENT_MAJOR(2)/2 z];
    p2 = [x+PROBE.ELEMENT_MINOR(1)/2 y-PROBE.ELEMENT_MAJOR(2)/2 z];
    p3 = [x+PROBE.ELEMENT_MINOR(1)/2 y+PROBE.ELEMENT_MAJOR(2)/2 z];
    p4 = [x-PROBE.ELEMENT_MINOR(1)/2 y+PROBE.ELEMENT_MAJOR(2)/2 z];
...
PROBE_P1 = [x-PROBE.ELEMENT_MINOR(1)/2 y-PROBE.ELEMENT_MAJOR(2)/2 z];
PROBE_P2 = [x-PROBE.ELEMENT_MINOR(1)/2 y+PROBE.ELEMENT_MAJOR(2)/2 z];
...
y = PROBE.ELEMENT_POSITION(2,1);
z = PROBE.ELEMENT_POSITION(3,1);
PROBE_P1 = [x1-PROBE.ELEMENT_MINOR(1)/2 y-PROBE.ELEMENT_MAJOR(2)/2 z];
PROBE_P2 = [x2+PROBE.ELEMENT_MINOR(1)/2 y-PROBE.ELEMENT_MAJOR(2)/2 z];
PROBE_P3 = [x2+PROBE.ELEMENT_MINOR(1)/2 y-PROBE.ELEMENT_MAJOR(2)/2 PROBE_HEIGHT];
PROBE_P4 = [x1-PROBE.ELEMENT_MINOR(1)/2 y-PROBE.ELEMENT_MAJOR(2)/2 PROBE_HEIGHT];
X = [PROBE_P1(1) PROBE_P2(1) PROBE_P3(1) PROBE_P4(1) PROBE_P1(1)];
Y = [PROBE_P1(2) PROBE_P2(2) PROBE_P3(2) PROBE_P4(2) PROBE_P1(2)];
Z = [PROBE_P1(3) PROBE_P2(3) PROBE_P3(3) PROBE_P4(3) PROBE_P1(3)];
plot3(X,Y,Z,'k');
